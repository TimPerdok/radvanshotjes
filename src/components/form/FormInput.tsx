...
const Inputs: Inputs = {
  ...
  number: (props: object) => <Input {...props} type="number" variant="filled" />,
  color: (props: object) => <input {...props} type="color" />,
  float: (props: object) => <Input {...props} type="number" variant="filled" inputProps={{step: 0.01, min:0, max: 999999}} />
}
